...
class Chevydealer(scrapy.Spider):
    name = "chevydealer"

    domain = "http://www.chevydealer.com"
    phones = []
    ...
    def start_requests(self):
        url = "http://www.chevydealer.com/InventoryListing?0-1.IBehaviorListener.1-border-border_body-virtualVehicleComponentsContainer-locationSelection-updateLocationForm-goButton&make=chevrolet&pageTypeName=InventoryListing"
    ...
    def parse_content(self, response):
        ...
        if (item['store_name'] == ''):
            return
        item['phone_number'] =  response.xpath('.//span[@itemprop="telephone"]/text()').extract_first()
