...
class NarscosmeticsSpider(scrapy.Spider):
    name = "narscosmetics"
    uid_list = []

    payload = '<request> \
		<appkey>A44D9C08-EA99-11E3-9D45-19A558203F82</appkey> \
    ...
    def start_requests(self):
        ...
        for row in self.long_lat_reader:
            ...
            print row                
            yield scrapy.Request(url='http://hosted.where2getit.com/narscosmetics/ajax?xml_request=%s' % payload, callback=self.parse_store)
